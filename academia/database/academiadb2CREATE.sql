...
(
    ...
    INDEX `fk_Avaliacao_Usuario1_idx`
(
    `Usuario_codigous`
    ASC
),
...
(
    ...
    INDEX `fk_Treino_has_Exercicios_Exercicios1_idx`
(
    `Exercicios_codigoex`
    ASC
),
    INDEX `fk_Treino_has_Exercicios_Treino_idx`
(
    `Treino_codigotr`
    ASC
),
...
(
    ...
    REFERENCES `academiadb`.`Exercicios`
(
    `codigoex`
)
    ON DELETE NO ACTION
